...
# 2️⃣ 모델 생성
model = Sequential([
    Dense(1024, activation='relu', input_shape=(10,), kernel_regularizer=tf.keras.regularizers.l2(0.01)),
    BatchNormalization(),
...
# 8️⃣ 모델 저장
model.save('improved_model_without_datagen.h5')
print("\n모델이 'improved_model_without_datagen.h5'로 저장되었습니다.")
